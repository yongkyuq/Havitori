...
public class ProductActivity extends AppCompatActivity
    ...
    public void PHavitLogo(View v) {
//        Intent myIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.havitusa.com/"));
        Intent intent = new Intent(this, MainActivity.class);
        startActivity(intent);
    }
    public void PProductPage(View v) {
        Intent intent = new Intent(this, ProductActivity.class);
        startActivity(intent);
    }
    public void PContactPage(View v) {
        Intent intent = new Intent(this, ContactActivity.class);
        startActivity(intent);
    }
    public void DisposablePage(View v) {
        Intent intent = new Intent(this, DisposableActivity.class);
        startActivity(intent);
    }
    public void RechargerblePage(View v) {
        Intent intent = new Intent(this, RechargeableActivity.class);
        startActivity(intent);
    }
    public void PAboutPage(View v) {
