...
public class RechargeableActivity extends AppCompatActivity
    ...
    public void RHavitLogo(View v) {
//        Intent myIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.havitusa.com/"));
        Intent intent = new Intent(this, MainActivity.class);
        startActivity(intent);
    }
    public void RProductPage(View v) {
        Intent intent = new Intent(this, ProductActivity.class);
        startActivity(intent);
    }
    public void RContactPage(View v) {
        Intent intent = new Intent(this, ContactActivity.class);
        startActivity(intent);
    }
    public void RechargeDetailPage1(View v) {
        Intent intent = new Intent(this, RechargeableDetailActivity.class);
        startActivity(intent);
    }
    public void RechargeDetailPage2(View v) {
        Intent intent = new Intent(this, RechargeableDetailActivity2.class);
        startActivity(intent);
    }
    public void RAboutPage(View v) {
