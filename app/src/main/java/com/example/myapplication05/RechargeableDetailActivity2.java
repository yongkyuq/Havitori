...
public class RechargeableDetailActivity2 extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recharge_detail2);
    ...
    public void R2HavitLogo(View v) {
//        Intent myIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.havitusa.com/"));
        Intent intent = new Intent(this, MainActivity.class);
        startActivity(intent);
    }

    public void R2ProductPage(View v) {
        Intent intent = new Intent(this, ProductActivity.class);
        startActivity(intent);
    }
    public void R2ContactPage(View v) {
        Intent intent = new Intent(this, ContactActivity.class);
        startActivity(intent);
    }
    public void R2AboutPage(View v) {
